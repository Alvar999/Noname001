public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	...
	if(dialogid == DIALOG_VONGQUAY)
    {
        if(response)
        {
            switch(listitem)
            {
                case 0:
                {
                    new vongquay[1280], str1[1280], str2[1280], str3[1280], str4[1280], str5[1280], str6[1280], str7[1280], str8[1280], str9[1280];
                    format(str1, sizeof(vongquay), "{ffffff}XIN CHAO : {00ffff}%s", GetPlayerNameEx(playerid));
                    format(str2, sizeof(vongquay), "{ffffff}Ban co muon thu may man cua minh voi tro choi {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} ?");
                    format(str3, sizeof(vongquay), "{ffffff}Truoc khi su dung {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} ban can biet nhung dieu nhu sau:");
                    format(str4, sizeof(vongquay), "{ffffff}    + Day la vong quay may man ngau nhien , nen khi ban quay ra nhung thu khong nhu y muon ban thi cung phai chiu. :V");
                    format(str5, sizeof(vongquay), "{ffffff}    + Se co 2 vong quay ngau nhien : {33cc33}VONG QUAY ${FFFFFF} va {ffff00}VONG QUAY CREDITS{FFFFFF}");
                    format(str6, sizeof(vongquay), "{ffffff}    + {33cc33}VONG QUAY ${FFFFFF} GIA : {009900}%d{ffffff}", VongQuay_Money);
                    format(str7, sizeof(vongquay), "{ffffff}    + {ffff00}VONG QUAY CREDITS{FFFFFF} GIA : {009900}%d{ffffff}", VongQuay_Credits);
                    format(str8, sizeof(vongquay), "{ff3300}PHAN THUONG :");
                    format(str9, sizeof(vongquay), "{ffffff}    + {00ccff}VEHICLE{ffffff} || {009933}MONEY{FFFFFF} || {ffff00}CREDITS{ffffff} || {9966ff}TOYS{ffffff}");
                    format(vongquay, sizeof(vongquay), "%s\n\n%s\n%s\n\n%s\n%s\n%s\%s\n\n%s\n\n%s", str1,str2,str3,str4,str5,str6,str7,str8,str9);
                    ShowPlayerDialog(playerid, DIALOG_NOTHING, DIALOG_STYLE_MSGBOX, "GTAVIET.NET || VONG QUAY MAY MAN", vongquay, "Dong y", "Huy bo");
                    return 1;
                }
                case 1:
                {
                    new vongquay[1280], str1[1280], str2[1280], str3[1280], str4[1280], str5[1280], str6[1280], str7[1280], str8[1280];
                    format(str1, sizeof(vongquay), "{ffffff}XIN CHAO : {00ffff}%s", GetPlayerNameEx(playerid));
                    format(str2, sizeof(vongquay), "{ffffff}Ban co muon thu may man cua minh voi tro choi {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} ?");
                    format(str3, sizeof(vongquay), "{ffffff}Neu ban muon su dung{ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}:");
                    format(str4, sizeof(vongquay), "{ffffff}    + {33cc33}VONG QUAY ${FFFFFF} GIA : {009900}%d{ffffff}", VongQuay_Money);
                    format(str5, sizeof(vongquay), "{ff3300}PHAN THUONG :");
                    format(str6, sizeof(vongquay), "{ffffff}    + {00ccff}VEHICLE{ffffff} || {009933}MONEY{FFFFFF} || {ffff00}CREDITS{ffffff} || {9966ff}TOYS{ffffff}");
                    format(str7, sizeof(vongquay), "{ffffff}Phan Thuong Cao Nhat La xe {07f0f6}Infernus {ffffff}, neu choi ban vui long nhan {ff0000}'Dong y'");
                    format(str8, sizeof(vongquay), "{ffffff}Neu da chac chac muon quay , ban vui long nhan {ff0000}'Dong y'");
                    format(vongquay, sizeof(vongquay), "%s\n\n%s\n%s\n\n%s\n\n%s\n%s", str1,str2,str3,str4,str5,str6,str7);
                    ShowPlayerDialog(playerid, VONGQUAY_SAD, DIALOG_STYLE_MSGBOX, "GTAVIET || VONG QUAY MAY MAN", vongquay, "Dong y", "Huy bo");
                }
                case 2:
                {
                    new vongquay[1280], str1[1280], str2[1280], str3[1280], str4[1280], str5[1280], str6[1280], str7[1280], str8[1280];
                    ...
                    format(str2, sizeof(vongquay), "{ffffff}Ban co muon thu may man cua minh voi tro choi {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} ?");
                    format(str3, sizeof(vongquay), "{ffffff}Neu ban muon su dung{ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}:");
                    format(str4, sizeof(vongquay), "{ffffff}    + {ffff00}VONG QUAY CREDITS{FFFFFF} GIA : {009900}%d{ffffff}", VongQuay_Credits);
                    format(str5, sizeof(vongquay), "{ff3300}PHAN THUONG :");
                    format(str6, sizeof(vongquay), "{ffffff}    + {00ccff}VEHICLE{ffffff} || {009933}MONEY{FFFFFF} || {ffff00}CREDITS{ffffff} || {9966ff}TOYS{ffffff}");
                    format(str7, sizeof(vongquay), "{ffffff}Phan Thuong Cao Nhat La xe {07f0f6}S.F.P.D {ffffff}, neu choi ban vui long nhan {ff0000}'Dong y'");
                    format(str8, sizeof(vongquay), "{ffffff}Neu da chac chac muon quay , ban vui long nhan {ff0000}'Dong y'");
                    format(vongquay, sizeof(vongquay), "%s\n\n%s\n%s\n\n%s\n\n%s\n%s", str1,str2,str3,str4,str5,str6,str7);
                    ShowPlayerDialog(playerid, VONGQUAY_CREDITS, DIALOG_STYLE_MSGBOX, "GTAVIET || VONG QUAY MAY MAN", vongquay, "Dong y", "Huy bo");
                }
            }
        }
    }

    if(dialogid == VONGQUAY_CREDITS)
    {
        if(response) // VONG QUAY CREDITS
        {
            if(PlayerInfo[playerid][pCredits] >= VongQuay_Credits)
            {
                if(VongQuay[playerid] == 0)
                {
	                PlayerInfo[playerid][pCredits] -= VongQuay_Credits;

	                VongQuay[playerid] = 0;

	                new str[1280];
					format(str, sizeof(str), "Ban vua su dung {ffff00}%d credits{ffffff} de choi {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}.", VongQuay_Credits);
					SendClientMessage(playerid, -1, str);

                    new phanthuong = random(100);
                    {
                        switch(phanthuong)
						{
						    case 0..70: VongQuay_Sadd2(playerid);
						    case 71..80: VongQuay_Creditss2(playerid);
						    case 81..94: VongQuay_Toys2(playerid);
						    case 95..100: VongQuay_Xe2(playerid);
						}
                    }
					return 1;
				}else SendClientMessage(playerid, -1, "Ban dang su dung vong quay , vui long doi.");
            }else SendClientMessage(playerid, -1, "Ban khong co du {ffff00}credits{FFFFFF} de su dung vong quay.");
        }
    }

    if(dialogid == VONGQUAY_SAD)
    {
        if(response) // VONG QUAY SAD
        {
            if(PlayerInfo[playerid][pCash] >= VongQuay_Money)
            {
                if(VongQuay[playerid] == 0)
                {
	                PlayerInfo[playerid][pCash] -= VongQuay_Money;

	                VongQuay[playerid] = 0;

	                new str[1280];
					format(str, sizeof(str), "Ban vua su dung {009933}%d${ffffff} de choi {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}.", VongQuay_Money);
					SendClientMessage(playerid, -1, str);
                    ...
                    new phanthuong = random(100);
                    {
                        switch(phanthuong)
						{
						    case 0..70: VongQuay_Sadd(playerid);
						    case 71..80: VongQuay_Creditss(playerid);
						    case 81..94: VongQuay_Toys(playerid);
						    case 95..100: VongQuay_Xe(playerid);
						}
                    }
					return 1;
				}else SendClientMessage(playerid, -1, "Ban dang su dung vong quay , vui long doi.");
            }else SendClientMessage(playerid, -1, "Ban khong co du {33cc33}${FFFFFF} de su dung vong quay.");
        }
    }
    if(dialogid == VONGQUAY_1)
	{
		if(response)
		{
			new toyid = GetPVarInt(playerid, "ToyID"), stringg[128];

			if(!toyCountCheck(playerid)) return SendClientMessageEx(playerid, COLOR_YELLOW, "* Nguoi choi nay khong nhan duoc them do choi!");
			if(PlayerToyInfo[playerid][listitem][ptModelID] != 0) return SendClientMessageEx(playerid, COLOR_YELLOW, "* Nguoi choi nay da co mot do choi o slot do!");

			PlayerToyInfo[playerid][listitem][ptModelID] = IDToys[1];
			PlayerToyInfo[playerid][listitem][ptBone] = 1;
			PlayerToyInfo[playerid][listitem][ptTradable] = 1;
			VongQuayTimer[playerid] = gettime()+15;
			format(stringg, sizeof(stringg), "Ban vua nhan duoc mot Toys [ID: %d] tu {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}", toyid);
			SendClientMessageEx(playerid, COLOR_YELLOW, stringg);
			VongQuay[playerid] = 0;
			DeletePVar(playerid, "ToyID");
			new v = listitem;
			g_mysql_NewToy(playerid, v);
			return 1; // //{1550,339,355,371,19590}
		}
	}
	if(dialogid == VONGQUAY_2)
	{
		if(response)
		{
			new toyid = GetPVarInt(playerid, "ToyID"), stringg[128];
			...
			PlayerToyInfo[playerid][listitem][ptModelID] = IDToys[2];
			PlayerToyInfo[playerid][listitem][ptBone] = 1;
			PlayerToyInfo[playerid][listitem][ptTradable] = 1;
			VongQuayTimer[playerid] = gettime()+15;
			format(stringg, sizeof(stringg), "Ban vua nhan duoc mot Toys [ID: %d] tu {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}", toyid);
	...
	if(dialogid == VONGQUAY_3)
	{
		if(response)
		{
			...
			PlayerToyInfo[playerid][listitem][ptModelID] = IDToys[3];
			PlayerToyInfo[playerid][listitem][ptBone] = 1;
			PlayerToyInfo[playerid][listitem][ptTradable] = 1;
			VongQuayTimer[playerid] = gettime()+15;
			format(stringg, sizeof(stringg), "Ban vua nhan duoc mot Toys [ID: %d] tu {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}", toyid);
	...
	if(dialogid == VONGQUAY_4)
	{
		if(response)
		{
			...
			PlayerToyInfo[playerid][listitem][ptModelID] = IDToys[4];
			PlayerToyInfo[playerid][listitem][ptBone] = 1;
			PlayerToyInfo[playerid][listitem][ptTradable] = 1;
			VongQuayTimer[playerid] = gettime()+15;
			format(stringg, sizeof(stringg), "Ban vua nhan duoc mot Toys [ID: %d] tu {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}", toyid);
	...
	if(dialogid == VONGQUAY_5)
	{
		if(response)
		{
			...
			PlayerToyInfo[playerid][listitem][ptModelID] = IDToys[5];
			PlayerToyInfo[playerid][listitem][ptBone] = 1;
			PlayerToyInfo[playerid][listitem][ptTradable] = 1;
			VongQuayTimer[playerid] = gettime()+15;
			format(stringg, sizeof(stringg), "Ban vua nhan duoc mot Toys [ID: %d] tu {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}", toyid);
	...
	if(dialogid == VONGQUAY_6)
	{
		if(response)
		{
			...
			PlayerToyInfo[playerid][listitem][ptModelID] = IDToysVIP[1];
			PlayerToyInfo[playerid][listitem][ptBone] = 1;
			PlayerToyInfo[playerid][listitem][ptTradable] = 1;
			VongQuayTimer[playerid] = gettime()+15;
			format(stringg, sizeof(stringg), "Ban vua nhan duoc mot Toys [ID: %d] tu {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}", toyid);
	...
	if(dialogid == VONGQUAY_7)
	{
		if(response)
		{
			...
			PlayerToyInfo[playerid][listitem][ptModelID] = IDToysVIP[2];
			PlayerToyInfo[playerid][listitem][ptBone] = 1;
			PlayerToyInfo[playerid][listitem][ptTradable] = 1;
			VongQuayTimer[playerid] = gettime()+15;
			format(stringg, sizeof(stringg), "Ban vua nhan duoc mot Toys [ID: %d] tu {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}", toyid);
	...
	if(dialogid == VONGQUAY_8)
	{
		if(response)
		{
			...
			PlayerToyInfo[playerid][listitem][ptModelID] = IDToysVIP[3];
			PlayerToyInfo[playerid][listitem][ptBone] = 1;
			PlayerToyInfo[playerid][listitem][ptTradable] = 1;
			VongQuayTimer[playerid] = gettime()+15;
			format(stringg, sizeof(stringg), "Ban vua nhan duoc mot Toys [ID: %d] tu {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}", toyid);
	...
	if(dialogid == VONGQUAY_9)
	{
		if(response)
		{
			...
			PlayerToyInfo[playerid][listitem][ptModelID] = IDToysVIP[4];
			PlayerToyInfo[playerid][listitem][ptBone] = 1;
			PlayerToyInfo[playerid][listitem][ptTradable] = 1;
			VongQuayTimer[playerid] = gettime()+15;
			format(stringg, sizeof(stringg), "Ban vua nhan duoc mot Toys [ID: %d] tu {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}", toyid);
	...
	if(dialogid == VONGQUAY_10)
	{
		if(response)
		{
			...
			PlayerToyInfo[playerid][listitem][ptModelID] = IDToysVIP[5];
			PlayerToyInfo[playerid][listitem][ptBone] = 1;
			PlayerToyInfo[playerid][listitem][ptTradable] = 1;
			VongQuayTimer[playerid] = gettime()+15;
			format(stringg, sizeof(stringg), "Ban vua nhan duoc mot Toys [ID: %d] tu {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff}", toyid);
	...
	if(dialogid == AdminVongQuay)
    {
        if(response)
        {
            switch(listitem)
            {
                case 0:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{33cc33}EDIT GIA ${ffffff} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} ban vui long nhap gia:");
                    format(str2, sizeof(vongquay), "{ffffff}    + GIA HIEN TAI {33cc33}VONG QUAY ${FFFFFF} GIA : {009900}%d${ffffff}", VongQuay_Money);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_MONEY, DIALOG_STYLE_INPUT, "{33cc33}EDIT GIA ${ffffff}", vongquay, "Dong y", "Bo qua");
				}
				case 1:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ffff00}EDIT GIA CREDITS{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} ban vui long nhap gia:");
                    format(str2, sizeof(vongquay), "{ffffff}    + GIA HIEN TAI {ffff00}EDIT GIA CREDITS{FFFFFF} GIA : {009900}%d credits{ffffff}", VongQuay_Credits);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_CREDITS, DIALOG_STYLE_INPUT, "{ffff00}EDIT GIA CREDITS{FFFFFF}", vongquay, "Dong y", "Bo qua");
				}
				case 2:
				{
				    ShowPlayerDialog(playerid, EDIT_TOYS, DIALOG_STYLE_LIST, "EDIT TOYS IC", "TOYS 1\nTOYS 2\nTOYS 3\nTOYS 4\nTOYS 5", "Dong y", "Huy bo");
				}
				case 3:
				{
				    ShowPlayerDialog(playerid, EDIT_TOYSVIP, DIALOG_STYLE_LIST, "EDIT TOYS CREDITS", "TOYS 1\nTOYS 2\nTOYS 3\nTOYS 4\nTOYS 5", "Dong y", "Huy bo");
				}
				case 4:
				{
				    ShowPlayerDialog(playerid, EDIT_XEIC, DIALOG_STYLE_LIST, "EDIT XE IC", "XE 1\nXE 2\nXE 3\nXE 4\nXE 5", "Dong y", "Huy bo");
				}
				case 5:
				{
				    ShowPlayerDialog(playerid, EDIT_XECREDITS, DIALOG_STYLE_LIST, "EDIT XE CREDITS", "XE 1\nXE 2\nXE 3\nXE 4\nXE 5", "Dong y", "Huy bo");
				}
			}
		}
	}
	if(dialogid == EDIT_MONEY) {
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    VongQuay_Money = strval(inputtext);
				    format(string, 128, "Ban da doi thanh cong gia $ vong quay thanh : %d$.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
		}
	}
	if(dialogid == EDIT_CREDITS) {
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    VongQuay_Credits = strval(inputtext);
				    format(string, 128, "Ban da doi thanh cong gia credits vong quay thanh : %d credits.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_TOYS)
    {
        if(response)
        {
            switch(listitem)
            {
                ...
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff9900}EDIT ID TOYS IC{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID Toys:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID Toys 1 : {009900}%d{ffffff}", IDToys[0]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_TOYS1, DIALOG_STYLE_INPUT, "{ff9900}EDIT ID TOYS IC{FFFFFF} - 1", vongquay, "Dong y", "Bo qua");
                }
                case 1:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff9900}EDIT ID TOYS IC{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID Toys:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID Toys 2 : {009900}%d{ffffff}", IDToys[1]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_TOYS2, DIALOG_STYLE_INPUT, "{ff9900}EDIT ID TOYS IC{FFFFFF} - 2", vongquay, "Dong y", "Bo qua");
                }
                case 2:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff9900}EDIT ID TOYS IC{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID Toys:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID Toys 3 : {009900}%d{ffffff}", IDToys[2]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_TOYS3, DIALOG_STYLE_INPUT, "{ff9900}EDIT ID TOYS IC{FFFFFF} - 3", vongquay, "Dong y", "Bo qua");
                }
                case 3:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff9900}EDIT ID TOYS IC{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID Toys:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID Toys 4 : {009900}%d{ffffff}", IDToys[3]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_TOYS4, DIALOG_STYLE_INPUT, "{ff9900}EDIT ID TOYS IC{FFFFFF} - 4", vongquay, "Dong y", "Bo qua");
                }
                case 4:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff9900}EDIT ID TOYS IC{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID Toys:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID Toys 5 : {009900}%d{ffffff}", IDToys[4]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_TOYS5, DIALOG_STYLE_INPUT, "{ff9900}EDIT ID TOYS IC{FFFFFF} - 5", vongquay, "Dong y", "Bo qua");
                }
			}
		}
	}

	if(dialogid == EDIT_TOYS1)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDToys[0] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID Toys IC 1 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_TOYS2)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDToys[1] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID Toys IC 2 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_TOYS3)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDToys[2] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID Toys IC 3 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_TOYS4)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDToys[3] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID Toys IC 4 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_TOYS5)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDToys[4] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID Toys IC 5 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_TOYSVIP)
    {
        if(response)
        {
            switch(listitem)
            {
                ...
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff9900}EDIT ID TOYS CREDITS{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID Toys:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID Toys 1 : {009900}%d{ffffff}", IDToysVIP[0]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_TOYSVIP1, DIALOG_STYLE_INPUT, "{ff9900}EDIT ID TOYS IC{FFFFFF} - 1", vongquay, "Dong y", "Bo qua");
                }
                case 1:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff9900}EDIT ID TOYS CREDITS{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID Toys:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID Toys 2 : {009900}%d{ffffff}", IDToysVIP[1]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_TOYSVIP2, DIALOG_STYLE_INPUT, "{ff9900}EDIT ID TOYS IC{FFFFFF} - 2", vongquay, "Dong y", "Bo qua");
                }
                case 2:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff9900}EDIT ID TOYS CREDITS{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID Toys:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID Toys 3 : {009900}%d{ffffff}", IDToysVIP[2]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_TOYSVIP3, DIALOG_STYLE_INPUT, "{ff9900}EDIT ID TOYS IC{FFFFFF} - 3", vongquay, "Dong y", "Bo qua");
                }
                case 3:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff9900}EDIT ID TOYS CREDITS{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID Toys:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID Toys 4 : {009900}%d{ffffff}", IDToysVIP[3]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_TOYSVIP4, DIALOG_STYLE_INPUT, "{ff9900}EDIT ID TOYS IC{FFFFFF} - 4", vongquay, "Dong y", "Bo qua");
                }
                case 4:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff9900}EDIT ID TOYS CREDITS{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID Toys:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID Toys 5 : {009900}%d{ffffff}", IDToysVIP[4]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_TOYSVIP5, DIALOG_STYLE_INPUT, "{ff9900}EDIT ID TOYS IC{FFFFFF} - 5", vongquay, "Dong y", "Bo qua");
                }
			}
		}
	}

	if(dialogid == EDIT_TOYSVIP1)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDToysVIP[0] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID Toys CREDITS 1 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_TOYSVIP2)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDToysVIP[1] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID Toys CREDITS 2 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_TOYSVIP3)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDToysVIP[2] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID Toys CREDITS 3 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_TOYSVIP4)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDToysVIP[3] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID Toys CREDITS 4 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_TOYSVIP5)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDToysVIP[4] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID Toys CREDITS 5 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_XEIC)
    {
        if(response)
        {
            switch(listitem)
            {
                ...
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff8080}EDIT ID XE IC{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID XE:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID XE 1 : {009900}%d{ffffff}", IDXeThuong[0]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_XE1, DIALOG_STYLE_INPUT, "{ff8080}EDIT ID XE IC{FFFFFF} - 1", vongquay, "Dong y", "Bo qua");
                }
                case 1:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff8080}EDIT ID XE IC{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID XE:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID XE 2 : {009900}%d{ffffff}", IDXeThuong[1]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_XE2, DIALOG_STYLE_INPUT, "{ff8080}EDIT ID XE IC{FFFFFF} - 2", vongquay, "Dong y", "Bo qua");
                }
                case 2:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff8080}EDIT ID XE IC{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID XE:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID XE 3 : {009900}%d{ffffff}", IDXeThuong[2]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_XE3, DIALOG_STYLE_INPUT, "{ff8080}EDIT ID XE IC{FFFFFF} - 3", vongquay, "Dong y", "Bo qua");
                }
                case 3:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff8080}EDIT ID XE IC{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID XE:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID XE 4 : {009900}%d{ffffff}", IDXeThuong[3]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_XE4, DIALOG_STYLE_INPUT, "{ff8080}EDIT ID XE IC{FFFFFF} - 4", vongquay, "Dong y", "Bo qua");
                }
                case 4:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff8080}EDIT ID XE IC{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID XE:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID XE 5 : {009900}%d{ffffff}", IDXeThuong[4]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_XE5, DIALOG_STYLE_INPUT, "{ff8080}EDIT ID XE IC{FFFFFF} - 5", vongquay, "Dong y", "Bo qua");
                }
			}
		}
	}

	if(dialogid == EDIT_XE1)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDXeThuong[0] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID XE 1 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_XE2)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDXeThuong[1] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID XE 2 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_XE3)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDXeThuong[2] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID XE 3 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_XE4)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDXeThuong[3] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID XE 4 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_XE5)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDXeThuong[4] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID XE 5 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_XECREDITS)
    {
        if(response)
        {
            switch(listitem)
            {
                ...
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff0000}EDIT ID XE CREDITS{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID XE:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID XE 1 : {009900}%d{ffffff}", IDXeVIP[0]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_XEVIP1, DIALOG_STYLE_INPUT, "{ff0000}EDIT ID XE CREDITS{FFFFFF} - 1", vongquay, "Dong y", "Bo qua");
                }
                case 1:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff0000}EDIT ID XE CREDITS{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID XE:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID XE 2 : {009900}%d{ffffff}", IDXeVIP[1]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_XEVIP2, DIALOG_STYLE_INPUT, "{ff0000}EDIT ID XE CREDITS{FFFFFF} - 2", vongquay, "Dong y", "Bo qua");
                }
                case 2:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff0000}EDIT ID XE CREDITS{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID XE:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID XE 3 : {009900}%d{ffffff}", IDXeVIP[2]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_XEVIP3, DIALOG_STYLE_INPUT, "{ff0000}EDIT ID XE CREDITS{FFFFFF} - 3", vongquay, "Dong y", "Bo qua");
                }
                case 3:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff0000}EDIT ID XE CREDITS{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID XE:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID XE 4 : {009900}%d{ffffff}", IDXeVIP[3]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_XEVIP4, DIALOG_STYLE_INPUT, "{ff0000}EDIT ID XE CREDITS{FFFFFF} - 4", vongquay, "Dong y", "Bo qua");
                }
                case 4:
                {
                    new vongquay[1280], str1[1280], str2[1280];
                    format(str1, sizeof(vongquay), "{ff0000}EDIT ID XE CREDITS{FFFFFF} {ffff00}VONG QUAY MAY MAN {00ff00}GTAVIET.NET{ffffff} Ban vui long nhap ID XE:");
                    format(str2, sizeof(vongquay), "{ffffff}    + ID XE 5 : {009900}%d{ffffff}", IDXeVIP[4]);
                    format(vongquay, sizeof(vongquay), "%s\n\n%s", str1,str2);
                    ShowPlayerDialog(playerid, EDIT_XEVIP5, DIALOG_STYLE_INPUT, "{ff0000}EDIT ID XE CREDITS{FFFFFF} - 5", vongquay, "Dong y", "Bo qua");
                }
			}
		}
	}

	if(dialogid == EDIT_XEVIP1)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDXeVIP[0] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID XE CREDITS 1 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_XEVIP2)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDXeVIP[1] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID XE CREDITS 2 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_XEVIP3)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDXeVIP[2] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID XE CREDITS 3 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_XEVIP4)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDXeVIP[3] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID XE CREDITS 4 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == EDIT_XEVIP5)
	{
		if(response) {
			if(strval(inputtext) > 0) {
				if(PlayerInfo[playerid][pAdmin] >= 2)
				{
				    IDXeVIP[4] = strval(inputtext);
				    format(string, 128, "Ban da dieu chinh ID XE CREDITS 5 thanh : %d.", strval(inputtext));
					SendClientMessage(playerid, -1, string);
					return 1;
				}else SendClientMessage(playerid, -1,"Ban khong the su dung chuc nang nay.");
			}else SendClientMessage(playerid, -1,"So luong can ban phai lon hon 0!");
	...
	if(dialogid == Job_DaoVang) // xin viec
    {
        if(response)
        {
   			...
   			if(PlayerInfo[playerid][pLevel] >= 1)
			{
            	...
            	{
		        	GettingJob[playerid] = 35;
                	PlayerInfo[playerid][pJob] = GettingJob[playerid];
                	SendClientMessageEx(playerid, COLOR_YELLOW, "Ban Da Xin Viec Dao Vang Thanh Cong");
                	SendClientMessageEx(playerid, COLOR_YELLOW, "/map => Tim Duong => Dao Vang  De Lam Viec Nhe");
                }
                else return SendClientMessageEx(playerid, COLOR_YELLOW, "Ban Dang Co Cong Viec Vui Long Thoat Viec De Xin Viec Tiep!");
			}
			else return SendClientMessageEx(playerid, COLOR_GREY, "Ban phai dat it nhat level 1 moi co the tro thanh Dao Vang");
		}
            ...
            SendClientMessageEx(playerid, COLOR_YELLOW, "Chi VIP/Famed moi co the nhan duoc hai cong viec!");
		        	...
		        	GettingJob[playerid] = 35;
                	PlayerInfo[playerid][pJob2] = GettingJob[playerid];
                	SendClientMessageEx(playerid, COLOR_YELLOW, "Ban Da Xin Viec Dao Vang Thanh Cong");
                	SendClientMessageEx(playerid, COLOR_YELLOW, "/map => Tim Duong => Dao Vang  De Lam Viec Nhe");
                }
			...
			else return SendClientMessageEx(playerid, COLOR_GREY, "Ban phai dat it nhat level 2 moi co the tro thanh Dao Vang");
		}
	...
	if(dialogid == BANVANG)
	{
	    if(response)
	    {
            new vang1 = random(2000)- random(2000);
            new vang2 = vang1 + vang1 + vang1 + vang1 + vang1 + vang1 + vang1 + vang1 + vang1 + vang1+10000;
            if(listitem == 0)
            {
                if(PlayerInfo[playerid][pVang] >= 30)
     			{
                    PlayerInfo[playerid][pVang] -= 30;
                    GivePlayerCash(playerid,40000 + vang2 + vang2 + vang2 + vang2 + vang2);
                    SendClientMessage(playerid, COLOR_GREY, "Ban da ban 50 Gram vang.");
                    format(string, sizeof(string), "Thong Tin: Gia 50 Gram hien nay dang la: $%d.",40000 + vang2 + vang2 + vang2 + vang2 + vang2);
                    SendClientMessage(playerid, COLOR_RED, string);
                    return 1;
                }
				else
				{
				    SendClientMessage(playerid, COLOR_GREY, "Khong du vang hay cung cap them");
				}
            }
            if(listitem == 1)
            {
                if(PlayerInfo[playerid][pVang] >= 50)
     			{
                    PlayerInfo[playerid][pVang] -= 50;
                    GivePlayerCash(playerid,80000 + vang2);
                    SendClientMessage(playerid, COLOR_GREY, "Ban da ban 30 Gram vang");
                    format(string, sizeof(string), "Thong Tin: Gia 30 Gram hien nay dang la: $%d.",80000 + vang2);
                    SendClientMessage(playerid, COLOR_RED, string);
                    return 1;
                }
				else
            ...
            if(listitem == 2)
            {
               if(PlayerInfo[playerid][pVang] >= 60)
     			{
                    PlayerInfo[playerid][pVang] -= 60;
                    GivePlayerCash(playerid,120000 + vang2 + vang2);
                    SendClientMessage(playerid, COLOR_GREY, "Ban da ban 60 Gram vang");
                    format(string, sizeof(string), "Thong Tin: Gia 60 Gram hien nay dang la: $%d.",120000 + vang2 + vang2);
                    SendClientMessage(playerid, COLOR_RED, string);
                    return 1;
                }
				else
            ...
            if(listitem == 3)
            {
                if(PlayerInfo[playerid][pVang] >= 80)
     			{
                    PlayerInfo[playerid][pVang] -= 80;
                    GivePlayerCash(playerid,130000 + vang2 + vang2 + vang2);
                    SendClientMessage(playerid, COLOR_GREY, "Ban da ban 80 Gram vang");
                    format(string, sizeof(string), "Thong Tin: Gia 80 Gram hien nay dang la: $%d.",160000 + vang2 + vang2 + vang2);
                    SendClientMessage(playerid, COLOR_RED, string);
                    return 1;
                }
				else
            ...
            if(listitem == 4)  ///VANVU
            {
                if(PlayerInfo[playerid][pVang] >= 100)
     			{
                    PlayerInfo[playerid][pVang] -= 100;
                    GivePlayerCash(playerid,150000 + vang2 + vang2 + vang2 + vang2);
                    SendClientMessage(playerid, COLOR_GREY, "Ban da ban 100 Gram vang");
                    format(string, sizeof(string), "Thong Tin: Gia 100 Gram hien nay dang la: $%d.",150000 + vang2 + vang2 + vang2 + vang2);
                    SendClientMessage(playerid, COLOR_RED, string);
                    return 1;
                }
				else
            ...
            if(listitem == 5)
            {
            	    SendClientMessage(playerid, COLOR_RED, "Gia bien dong nhu the nao,Administrator khong chiu trach nhiem.");
            	    format(string, sizeof(string), "Thong Tin: Gia 1 Gram hien nay dang la: $%d.",vang1+5000);
	...
	/*if((dialogid == TRANGTHAI)) {
		if(response)
		{
			if(listitem == 0)
			{
				glob2B74[playerid] = 1;
				SendClientMessage(playerid, 0xFFFFFFAA, "Ban Da Bat Che Do Roleplay");
				return 1;
			}
			if(listitem == 1)
			{
				glob2B74[playerid] = 2;
				SendClientMessage(playerid, 0xFFFFFFAA, "Ban Da Bat Che Do TDM");
				return 1;
			}
			if(listitem == 2)
			{
				glob2B74[playerid] = 3;
			    SendClientMessage(playerid, 0xFFFFFFAA, "Ban Da Bat Che Do Hoa Binh");
			    return 1;
			}
		}
	}*/
	
	if(dialogid == TROGIUPTETNGUYENDAN)
    {
        if(response)
        {
            if(listitem == 0)// Vi Tri Lay La Chuoi
            {
                SetPlayerCheckpoint(playerid, 1817.24,-1570.31,13.54, 5);
                CP[playerid] = 252006;
            }
            else if(listitem == 1)// Vi Tri Lay Gao
            {
                SetPlayerCheckpoint(playerid, 1818.37,-1565.04,13.54, 5);
				PlayerPlaySound(playerid,1149,0.0,0.0,0.0);
                CP[playerid] = 252006;
            }
            else if(listitem == 2)// Vi Tri Che Bien Banh
            {
                SetPlayerCheckpoint(playerid, 1811.67,-1565.57,13.46, 5);
				PlayerPlaySound(playerid,1149,0.0,0.0,0.0);
                CP[playerid] = 252006;
            }
            else if(listitem == 3)// Vi tri Ban Banh
            {
                SetPlayerCheckpoint(playerid, 1809.27,-1567.85,13.46, 5);
				PlayerPlaySound(playerid,1149,0.0,0.0,0.0);
                CP[playerid] = 252006;
	        }
	        else if(listitem == 4)// Vi Tri NPC
	        {
		        SetPlayerCheckpoint(playerid, 1806.63,-1569.50,13.47, 5);
		        PlayerPlaySound(playerid,1149,0.0,0.0,0.0);
		        CP[playerid] = 252006;
		    }
        }
	...
	if(dialogid == Dialog_Phone_DanhBa)
	{
	    if(response)
	    {

	        format(string,256,"%d",strval(inputtext));
	        cmd_sdt(playerid,string);
	    }
	    return 1;
	}
	if(dialogid == Dialog_Phone_SMS2)
	{
	    if(response)
	    {
	        format(string,256,"%d %s",GetPVarInt(playerid,"Call"),inputtext);
	        cmd_sms(playerid,string);
	    }
	    return 1;
	}
	if(dialogid == Dialog_Phone_SMS1)
	{
	    if(response)
	    {
	        new number = strval(inputtext);
	        SetPVarInt(playerid,"Call",number);
	        ShowPlayerDialog(playerid, Dialog_Phone_SMS2, DIALOG_STYLE_INPUT, "Phone - Nhan tin", "Vui long nhap noi dung tin nhan", "Gui", "Huy bo");
	    }
	    return 1;
	}
	...
	if(dialogid == Dialog_Phone_Bank2)
	{
	    if(response)
	    {
	        new tien = strval(inputtext);
	        format(string,256,"%d %d",GetPVarInt(playerid,"Call"),tien);
	        cmd_chuyentien(playerid,string);
	    }
	    return 1;
	}
	if(dialogid == Dialog_Phone_Bank1)
	{
	    if(response)
	    {
	        new ID = strval(inputtext);
	        SetPVarInt(playerid,"Call",ID);
    		format(string,256,"Nguoi nhan: %s\n\nSo du hien tai cua ban: %s\n\nNhap so tien ban can chuyen",GetPlayerNameExt(ID),number_format(PlayerInfo[playerid][pAccount]));
    		ShowPlayerDialog(playerid, Dialog_Phone_Bank2, DIALOG_STYLE_INPUT, "Phone - Chuyen tien", string, "Tiep tuc", "Huy bo");
	    }
	    return 1;
	}
	if(dialogid == Dialog_Phone)
	{
	    if(response)
	    {
	        ...
	        if(listitem == 0)//Goi
			{
			    ShowPlayerDialog(playerid, Dialog_Phone_Call, DIALOG_STYLE_INPUT, "Phone - Goi dien", "Vui long nhap SDT ban muon goi", "Goi", "Huy bo");
			}
			if(listitem == 1)//Tin nhan
			{
			    ShowPlayerDialog(playerid, Dialog_Phone_SMS1, DIALOG_STYLE_INPUT, "Phone - Nhan tin", "Vui long nhap SDT ban can gui tin nhan", "Tiep tuc", "Huy bo");
			}
			if(listitem == 2)//Log sms
			{
			    cmd_asmslog(playerid, "");
			}
			if(listitem == 3)//danh ba
			{
			    ShowPlayerDialog(playerid, Dialog_Phone_DanhBa, DIALOG_STYLE_INPUT, "Phone - Danh Ba", "Vui long nhap ID nguoi choi", "Tim", "Huy bo");
			}
			if(listitem == 4)//chuyen tien
			{
			    ShowPlayerDialog(playerid, Dialog_Phone_Bank1, DIALOG_STYLE_INPUT, "Phone - Chuyen tien", "Vui long nhap ID nguoi choi", "Tiep tuc", "Huy bo");
			}
		}
		return 1;
	}
	...
	// Actor Black Market
	if(dialogid == ACTOR_DRUGSDEALER)
    {
        if(response)
        {
            if(listitem == 0) //Ban can sa
		    {
				ShowPlayerDialog(playerid, BANCANSA, DIALOG_STYLE_INPUT, "NPC Drugs Dealer", "Nhap so luong can sa ban muon ban' vao day:", "Lua chon", "Huy bo");
			}
            if(listitem == 1) //Ban ma tuy
		    {
				ShowPlayerDialog(playerid, BANMATUY, DIALOG_STYLE_INPUT, "NPC Drugs Dealer", "Nhap so luong ma tuy ban muon ban' vao day:", "Lua chon", "Huy bo");
			}			
			return 1;
        }
    }
	if(dialogid == ACTOR_ARMSDEALER)
    {
        if(response)
        {
            if(listitem == 0) //Mua vu khi
		    {	
				format(string,sizeof(string),"Brass Knuckles\nGolf Club\nBaseball Bat\nShovel\nPool Cue\nKatana\nFlowers\nCane\n9mm\nSilenced 9mm\nDesert Eagle\nShotgun\nMicro SMG/Uzi\nTec-9\nCountry Rifle");
				ShowPlayerDialog(playerid, MUAVUKHI, DIALOG_STYLE_LIST, "NPC Arms Dealer", string, "OK", "");
			}
			return 1;
        }
    }	
    
    if(dialogid == BANCANSA)
    {
        if(!response) return 0;
        new soluongcansa = strval(inputtext);
        if(soluongcansa == 0) return ShowPlayerDialog(playerid, BANCANSA, DIALOG_STYLE_INPUT, "NPC Drugs Dealer", "Vui long nhap dung so luong!", "Lua chon", "Huy bo");
        if(PlayerInfo[playerid][pPot] < soluongcansa) return ShowPlayerDialog(playerid, BANCANSA, DIALOG_STYLE_INPUT, "NPC Drugs Dealer", "Ban khong co du so luong da nhap!", "Lua chon", "Huy bo");
        
        PlayerInfo[playerid][pPot] -= soluongcansa;
        format(string, sizeof(string), "Ban da ban %d can sa nguyen chat va nhan duoc %d tien ban [ /qs ]", soluongcansa, soluongcansa*3000);
        SendClientMessageEx(playerid, COLOR_LIGHTBLUE, string);
        PlayerInfo[playerid][pDirtyMoney] += soluongcansa*3000;
    }
    
    if(dialogid == BANMATUY)
    {
        if(!response) return 0;
        new soluongmatuy = strval(inputtext);
        if(soluongmatuy == 0) return ShowPlayerDialog(playerid, BANMATUY, DIALOG_STYLE_INPUT, "NPC Drugs Dealer", "Vui long nhap dung so luong!", "Lua chon", "Huy bo");
        if(PlayerInfo[playerid][pCrack] < soluongmatuy) return ShowPlayerDialog(playerid, BANMATUY, DIALOG_STYLE_INPUT, "NPC Drugs Dealer", "Ban khong co du so luong da nhap!", "Lua chon", "Huy bo");
        
        PlayerInfo[playerid][pCrack] -= soluongmatuy;
        format(string, sizeof(string), "Ban da ban' %d ma tuy nguyen chat va nhan duoc %d tien ban [ /qs ]", soluongmatuy, soluongmatuy*50);
        SendClientMessageEx(playerid, COLOR_LIGHTBLUE, string);
        PlayerInfo[playerid][pDirtyMoney] += soluongmatuy*50;
    }
	
	if(dialogid == ACTOR_POT)
    {
        if(response)
        {
            if(listitem == 0) //Huong dan cho nguoi moi
		    {
				format(string,sizeof(string),"B1: Tim vi tri thu hoach - Di vao ben trong ban se thay mot buc tuong rao, nhay vao ben trong\nse den noi thu hoach cay can sa.\nB2: Thu hoach can sa - Su dung lenh [/thuhoach cansa] de bat dau thu hoach can sa, se phai\nton mot khoang thoi gian nhat dinh nen hay can than canh sat\nB3: San xuat can sa - Sau khi da thu hoach du cay can sa, hay quay tro lai day va chon muc [Vi tri san xuat]\nde nhan checkpoint cua nha may che bien can sa, di den do va bat dau san xuat can sa nguyen chat (Pot)\nB4: Ban can sa cho Drug Dealer - Di den Black Market (cho den) de ban can sa cho Drug Dealer,\nneu ban khong biet Black Market o dau hay su dung lenh [/timduong] de nhan checkpoint den Black Market\nB5: Rua tien - Sau khi ban da ban can sa nguyen chat (Pot) cho Drug Dealer ban se nhan duoc mot so tien ban,\ndi den cho rua tien tai Rodeo [/timduong] de nhan checkpoint den cho rua tien\n{FFFF00}Luu y: Can than canh sat boi vi ban dang lam viec pham phap, neu bi bat ban se bi phat rat nang!!!\nChuc may man - From Dawkin with Love <3");
				ShowPlayerDialog(playerid, HUONGDANBUONCANSAMATUY, DIALOG_STYLE_MSGBOX, "Buon can sa", string, "OK", "");
			}
            if(listitem == 1) //Vi tri san xuat
		    {
				SetPlayerCheckpoint(playerid, 681.4966,-444.2834,16.3359, 5);
	...
	if(dialogid == ACTOR_CRACK)
    {
        if(response)
        {
            if(listitem == 0) //Huong dan cho nguoi moi
		    {	
				format(string,sizeof(string),"B1: Tim vi tri thu hoach - Tim xung quanh day co mot ngoi nha chua cay ma tuy de thu hoach.\nB2: Thu hoach ma tuy - Su dung lenh [/thuhoach matuy] de bat dau thu hoach ma tuy,\nse phai ton mot khoang thoi gian nhat dinh nen hay can than canh sat\nB3: San xuat ma tuy - Sau khi da thu hoach du cay ma tuy, hay quay tro lai day va chon muc [Vi tri san xuat]\nde nhan checkpoint cua nha may che bien ma tuy, di den do va\nbat dau san xuat ma tuy nguyen chat (Crack)\nB4: Ban ma tuy cho Drug Dealer - Di den Black Market (cho den) de ban ma tuy cho Drug Dealer,\nneu ban khong biet Black Market o dau hay su dung lenh [/timduong] de nhan checkpoint den Black Market\nB5: Rua tien - Sau khi ban da ban ma tuy nguyen chat (Crack) cho Drug Dealer ban se nhan duoc mot so tien ban,\ndi den cho rua tien tai Rodeo [/timduong] de nhan checkpoint den cho rua tien\n{FFFF00}Luu y: Can than canh sat boi vi ban dang lam viec pham phap, neu bi bat ban se bi phat rat nang!!!\nChuc may man - From Dawkin with Love <3");
				ShowPlayerDialog(playerid, HUONGDANBUONCANSAMATUY, DIALOG_STYLE_MSGBOX, "Buon ma tuy", string, "OK", "");
			}
            if(listitem == 1) //Vi tri san xuat
		    {
				SetPlayerCheckpoint(playerid, 681.4966,-444.2834,16.3359, 5);
    ...
    // cansa
   	if(dialogid == TROGIUPCANSA)
    {
        if(response)
        {
            if(listitem == 0)// Vi Tri Hai Can
            {
                SetPlayerCheckpoint(playerid, -1601.98059,-1323.96362,51.15684, 5);
				PlayerPlaySound(playerid,1149,0.0,0.0,0.0);
                CP[playerid] = 252006;
            }
            else if(listitem == 1)// Vi tri san xuat
            {
                SetPlayerCheckpoint(playerid, -2084.67,843.10,69.56, 5);
				PlayerPlaySound(playerid,1149,0.0,0.0,0.0);
                CP[playerid] = 252006;
            }
            else if(listitem == 2)// Vi Tri Ban
            {
                SetPlayerCheckpoint(playerid, -1627.56,872.25,8.16, 5);
				PlayerPlaySound(playerid,1149,0.0,0.0,0.0);
                CP[playerid] = 252006;
            }
            else if(listitem == 3)// Vi tri rua tien
            {
                SetPlayerCheckpoint(playerid, -2161.35,654.39,52.36, 5);
				PlayerPlaySound(playerid,1149,0.0,0.0,0.0);
                CP[playerid] = 252006;
	        }
        }
    ...
    if(dialogid == DIALOG_TETNGUYENDAN)
	{
	    if(response)
	    {
	        if(listitem == 0)
	        {
                return cmd_xemnguyenlieu(playerid, "");
		    }
	        if(listitem == 1)
	        {
		        return cmd_xembanhchung(playerid, "");
		    }
	    }
	}

    if(dialogid == BANBANHCHUNG)
    {
        if(!response) return 0;
        new soluongbanhchung = strval(inputtext);
        ShowPlayerDialog(playerid, BANBANHCHUNG, DIALOG_STYLE_INPUT, "NPC Ban Banh Chung", "Nhap so luong banh ban muon ban' vao day:", "Lua chon", "Huy bo");
        if(PlayerInfo[playerid][pBanhChung] < soluongbanhchung) return ShowPlayerDialog(playerid, BANBANHCHUNG, DIALOG_STYLE_INPUT, "NPC Ban Banh Chung", "Ban khong co banh chung", "Lua chon", "Huy bo");
        
        PlayerInfo[playerid][pBanhChung] -= soluongbanhchung;
        format(string, sizeof(string), "Ban da ban %d banh chung va nhan duoc %d tien", soluongbanhchung, soluongbanhchung*10000);
        SendClientMessageEx(playerid, COLOR_LIGHTBLUE, string);
        PlayerInfo[playerid][pCash] += soluongbanhchung*10000;
    }
    
    if(dialogid == DIALOG_LICENSE_BUY_TEST && response) // Thi bang lai - ngoc lam
	{
		switch (listitem)
		{
			case 0:
			{
			    if(PlayerInfo[playerid][pCarLic] == 0)
			    {
			        ...
			        {
			            SendClientMessageEx(playerid, COLOR_GREY, "{FF0033}RL-RP System{FFFFFF}: Ban khong du tien de nop phi cho khoa' hoc nay.");
						return 1;
			        }
			        else if(GetPVarInt(playerid, "hoclaixe") == 0)
			        {
						GivePlayerCash(playerid,-5000);
						SetPVarInt(playerid, "hoclaixe", 1);
						SendClientMessageEx(playerid, COLOR_GREY, "{FF0033}RL-RP System{FFFFFF}: Ban da dang ky thanh cong khoa' hoc lai xe.");
						ShowPlayerDialog(playerid, HOCLAIXE_STEP_1, DIALOG_STYLE_LIST, "O Viet Nam lai xe ben lan duong nao?", "Trai\nPhai\nO giua\nTren via he", "Chon", "Thoat");
					}
					else
					{
					    SendClientMessageEx(playerid, COLOR_WHITE, "{FF0033}RL-RP System{FFFFFF}: Ban dang trong khoa' hoc");
					}
				}
				else SendClientMessageEx(playerid, COLOR_GREY, "{FF0033}RL-RP System{FFFFFF}: Ban da co bang lai xe.");
			}
		}
	}
	if(dialogid == HOCLAIXE_STEP_1)
	{
	    if(response)
	    {
	        switch(listitem)
	        {
			            case 0:
						{
						SetPVarInt(playerid, "traloidung_hoclaixe", 0);
						ShowPlayerDialog(playerid, HOCLAIXE_STEP_2, DIALOG_STYLE_LIST, "Khai nien 'lan duong' duoc hieu nhu the nao?", "La phan duong duoc chia theo chieu ngang, co be rong du cho xe luu thong\nLa phan duong duoc chia theo chieu doc, co be rong du cho xe luu thong", "Chon", "Thoat");
						}
			            case 1:
						{
						SetPVarInt(playerid, "traloidung_hoclaixe", 1);
						ShowPlayerDialog(playerid, HOCLAIXE_STEP_2, DIALOG_STYLE_LIST, "Khai nien 'lan duong' duoc hieu nhu the nao?", "La phan duong duoc chia theo chieu ngang, co be rong du cho xe luu thong\nLa phan duong duoc chia theo chieu doc, co be rong du cho xe luu thong", "Chon", "Thoat");
						}
			            case 2:
						{
	    ...
	    {
	        ShowPlayerDialog(playerid, HUY_HOCLAIXE, DIALOG_STYLE_MSGBOX, "Huy hoc lai xe", "Ban chac chan muon huy khoa' hoc lai xe?", "OK", "Tu choi");
	    }
	}
	if(dialogid == HOCLAIXE_STEP_2)
	{
	    if(response)
	    {
	        switch(listitem)
	        {
			            case 0:
						{
						ShowPlayerDialog(playerid, HOCLAIXE_STEP_3, DIALOG_STYLE_LIST, "Phuong tien giao thong duong bo gom nhung phuong tien nao?", "Xe dap, xe may, oto, moto,...\t\t\t\t\nMay bay, tau lua, phi thuyen, thuyen\nGiap Ironman, Xe bay,...", "Chon", "Thoat");
						}
			            case 1:
						{
						SetPVarInt(playerid, "traloidung_hoclaixe", 2);
						ShowPlayerDialog(playerid, HOCLAIXE_STEP_3, DIALOG_STYLE_LIST, "Phuong tien giao thong duong bo gom nhung phuong tien nao?", "Xe dap, xe may, oto, moto,...\nMay bay, tau lua, phi thuyen, thuyen\nGiap Ironman, Xe bay,...", "Chon", "Thoat");
						}
	        }
	    }
	...
	if(dialogid == HOCLAIXE_STEP_3)
	{
	    if(response)
	    {
	        switch(listitem)
	        {
	                    case 0:
						{
						    SetPVarInt(playerid, "traloidung_hoclaixe", 3);
						    ShowPlayerDialog(playerid, HOCLAIXE_STEP_4, DIALOG_STYLE_LIST, "Nguoi tham gia giao thong duong bo gom nhung doi tuong nao?", "Nguoi dieu khien, dan theo suc vat, nguoi di bo tren le duong\t\t\t\nCho, meo, ga, vit\nMay bay, thuyen", "OK", "CANCEL");
						}
			            case 1:
						{
							ShowPlayerDialog(playerid, HOCLAIXE_STEP_4, DIALOG_STYLE_LIST, "Nguoi tham gia giao thong duong bo gom nhung doi tuong nao?", "Nguoi dieu khien, dan theo suc vat, nguoi di bo tren le duong\t\t\t\nCho, meo, ga, vit\nMay bay, thuyen", "OK", "CANCEL");
	...
	if(dialogid == HOCLAIXE_STEP_4)
	{
	    if(response)
	    {
	        switch(listitem)
	        {
		        case 0:
				{
					SetPVarInt(playerid, "traloidung_hoclaixe", 4);
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_5, DIALOG_STYLE_LIST, "Nhung hanh vi nao sau day khong bi cam?", "Bam' coi lien tuc, ru' ga lien tuc, khong doi mu bao hiem\nVan chuyen nguoi qua so luong qui dinh, phong nhanh, lang lach\nDoi mu bao hiem, di dung lan duong", "OK", "CANCEL");
				}
		        case 1:
				{
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_5, DIALOG_STYLE_LIST, "Nhung hanh vi nao sau day khong bi cam?", "Bam' coi lien tuc, ru' ga lien tuc, khong doi mu bao hiem\nVan chuyen nguoi qua so luong qui dinh, phong nhanh, lang lach\nDoi mu bao hiem, di dung lan duong", "OK", "CANCEL");
	...
	if(dialogid == HOCLAIXE_STEP_5)
	{
	    if(response)
	    {
			switch(listitem)
			{
		        case 0:
				{
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_6, DIALOG_STYLE_LIST, "Hanh vi bo? tron khi gay tai nan co bi nghiem cam hay khong? ", "Duoc khuyen khich\nNghiem cam\nKhong bi nghiem cam\nNghiem cam tuy truong hop", "OK", "CANCEL");
				}
		        case 1:
				{
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_6, DIALOG_STYLE_LIST, "Hanh vi bo? tron khi gay tai nan co bi nghiem cam hay khong? ", "Duoc khuyen khich\nNghiem cam\nKhong bi nghiem cam\nNghiem cam tuy truong hop", "OK", "CANCEL");
		        ...
		        case 2:
				{
				    SetPVarInt(playerid, "traloidung_hoclaixe", GetPVarInt(playerid, "traloidung_hoclaixe") + 1);
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_6, DIALOG_STYLE_LIST, "Hanh vi bo? tron khi gay tai nan co bi nghiem cam hay khong? ", "Duoc khuyen khich\nNghiem cam\nKhong bi nghiem cam\nNghiem cam tuy truong hop", "OK", "CANCEL");
				}
	        }
	    }
	...
	if(dialogid == HOCLAIXE_STEP_6)
	{
	    if(response)
	    {
	        switch(listitem)
	        {
		        case 0:
				{
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_7, DIALOG_STYLE_LIST, "Khi dieu khien xe tren duong cao toc, nhung viec nao khong cho phep? ", "Quay dau xe, lui xe, di nguoc chieu, chay xe o lan duong dung xe khan cap\nChay qua toc do toi thieu va duoi toc do toi da\nDung xe, do xe o noi quy dinh", "OK", "CANCEL");
				}
		        case 1:
				{
					SetPVarInt(playerid, "traloidung_hoclaixe", GetPVarInt(playerid, "traloidung_hoclaixe") + 1); ShowPlayerDialog(playerid, HOCLAIXE_STEP_7, DIALOG_STYLE_LIST, "Khi dieu khien xe tren duong cao toc, nhung viec nao khong cho phep? ", "Quay dau xe, lui xe, di nguoc chieu, chay xe o lan duong dung xe khan cap\nChay qua toc do toi thieu va duoi toc do toi da\nDung xe, do xe o noi quy dinh", "OK", "CANCEL");
				}
		        case 2:
				{
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_7, DIALOG_STYLE_LIST, "Khi dieu khien xe tren duong cao toc, nhung viec nao khong cho phep? ", "Quay dau xe, lui xe, di nguoc chieu, chay xe o lan duong dung xe khan cap\nChay qua toc do toi thieu va duoi toc do toi da\nDung xe, dau xe o noi quy dinh", "OK", "CANCEL");
				}
		        case 3:
				{
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_7, DIALOG_STYLE_LIST, "Khi dieu khien xe tren duong cao toc, nhung viec nao khong cho phep? ", "Quay dau xe, lui xe, di nguoc chieu, chay xe o lan duong dung xe khan cap\nChay qua toc do toi thieu va duoi toc do toi da\nDung xe, dau xe o noi quy dinh", "OK", "CANCEL");
	...
	if(dialogid == HOCLAIXE_STEP_7)
	{
        if(response)
	    {
	        switch(listitem)
	        {
		        case 0:
				{
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_8, DIALOG_STYLE_LIST, "Khi muon vuot xe khac, nguoi lai xe phai lam nhu the nao?", "Phai bao hieu bang den hoac coi xe\nPhong' cmn qua luon, so deo' gi @@\nTong no xe truoc roi vuot qua", "OK", "CANCEL");
				}
		        case 1:
				{
					SetPVarInt(playerid, "traloidung_hoclaixe", GetPVarInt(playerid, "traloidung_hoclaixe") + 1); ShowPlayerDialog(playerid, HOCLAIXE_STEP_8, DIALOG_STYLE_LIST, "Khi muon vuot xe khac, nguoi lai xe phai lam nhu the nao?", "Phai bao hieu bang den hoac coi xe\nPhong' cmn qua luon, so deo' gi @@\nTong no xe truoc roi vuot qua", "OK", "CANCEL");
				}
		        case 2:
				{
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_8, DIALOG_STYLE_LIST, "Khi muon vuot xe khac, nguoi lai xe phai lam nhu the nao?", "Phai bao hieu bang den hoac coi xe\nPhong' cmn qua luon, so deo' gi @@\nTong no xe truoc roi vuot qua", "OK", "CANCEL");
	...
	if(dialogid == HOCLAIXE_STEP_8)
	{
        if(response)
	    {
	        switch(listitem)
	        {
				...
				{
				    SetPVarInt(playerid, "traloidung_hoclaixe", GetPVarInt(playerid, "traloidung_hoclaixe") + 1);
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_9, DIALOG_STYLE_LIST, "Khi lui xe, nguoi lai xe phai lam gi de dam bao an toan? ", "Quan sat phia truoc va lui xe\nLui khong can nhin truoc nhin sau\nQuan sat phia sau, bat tin hieu coi xe,...", "OK", "CANCEL");
				}
		        case 1:
				{
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_9, DIALOG_STYLE_LIST, "Khi lui xe, nguoi lai xe phai lam gi de dam bao an toan? ", "Quan sat phia truoc va lui xe\nLui khong can nhin truoc nhin sau\nQuan sat phia sau, bat tin hieu coi xe,...", "OK", "CANCEL");
	...
	if(dialogid == HOCLAIXE_STEP_9)
	{
        if(response)
	    {
	        switch(listitem)
	        {
		        case 0:
				{
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_10, DIALOG_STYLE_LIST, "Nguoi lai xe phai lam gi khi dieu khien xe vao duong cao toc? ", "Phat tin hieu xin vao duong, nhuong duong cho xe dang chay nhanh\nVao luon, deo' so cm thang nao het :|\nPhong toc do cao khong nhuong xe khac", "OK", "CANCEL");
				}
		        case 1:
				{
					ShowPlayerDialog(playerid, HOCLAIXE_STEP_10, DIALOG_STYLE_LIST, "Nguoi lai xe phai lam gi khi dieu khien xe vao duong cao toc? ", "Phat tin hieu xin vao duong, nhuong duong cho xe dang chay nhanh\nVao luon, deo' so cm thang nao het :|\nPhong toc do cao khong nhuong xe khac", "OK", "CANCEL");
	...
	if(dialogid == HOCLAIXE_STEP_10)
	{
        if(response)
	    {
	        new str[256], str2[512];
	        //SetPVarInt(playerid, "hoclaixe", 2);
	        format(str, 256, "%s - Trac nghiem", GetPlayerNameEx(playerid));
	        format(str2, 512, "Ket qua - %s\nBan da tra loi dung %d/10 cau trac nghiem, chung ta se tiep tuc den phan thuc hanh", GetPlayerNameEx(playerid), GetPVarInt(playerid, "traloidung_hoclaixe"));
			ShowPlayerDialog(playerid, HOCLAIXE_XONGTRACNGHIEM, DIALOG_STYLE_MSGBOX, str, str2, "OK","");
	    }
	    else
	    {
	        ShowPlayerDialog(playerid, HUY_HOCLAIXE, DIALOG_STYLE_MSGBOX,"Huy hoc lai xe", "Ban chac chan muon huy khoa' hoc lai xe?", "OK", "Tu choi");
	...
	if(dialogid == HOCLAIXE_XONGTRACNGHIEM && response)
	{
		new Float: px, Float: py, Float: pz, Float: pa;
		GetPlayerPos(playerid, px, py, pz);
		GetPlayerFacingAngle(playerid, pa);
		SetPVarFloat(playerid, "hoclaixe_px", px);
		SetPVarFloat(playerid, "hoclaixe_py", py);
		SetPVarFloat(playerid, "hoclaixe_pz", pz);
		SetPVarFloat(playerid, "hoclaixe_pa", pa);
		SetPVarInt(playerid, "hoclaixe_vehicleid", CreateVehicle(400, 1408.2273,-1792.1929,13.5469, 359.8820, 79, -1, 0));
		SetVehicleHealth(GetPVarInt(playerid, "hoclaixe_vehicleid"), 1000);
		SetPVarInt(playerid, "hoclaixe_thuchanh", 0);
		SetPlayerInterior(playerid, 0);
		SetPlayerVirtualWorld(playerid, GetVehicleVirtualWorld(GetPVarInt(playerid, "hoclaixe_vehicleid")));
		PutPlayerInVehicle(playerid, GetPVarInt(playerid, "hoclaixe_vehicleid"), 0);
		SetPlayerRaceCheckpoint(playerid, 0, 1408.2273,-1792.1929,13.5469, 5);
		ShowPlayerDialog(playerid, DIALOG_NOTHING, DIALOG_STYLE_MSGBOX, "Huong dan", "Hay di den cac diem checkpoint de hoan thanh phan thuc hanh\nDung gay qua nhieu thiet hai cho xe vi no se tru diem thi cua ban\n\t\t-Scripter david_bullz", "OK", "");
	}
	if(dialogid == HUY_HOCLAIXE)
	{
	    if(response)
	    {
	        DeletePVar(playerid, "hoclaixe");
	        SendClientMessage(playerid, COLOR_WHITE, "{FF0033}RL-RP System{FFFFFF}: Da huy khoa' hoc lai xe");
	    }
	    else
	    {
	        ShowPlayerDialog(playerid, HOCLAIXE_STEP_1, DIALOG_STYLE_LIST, "O Viet Nam lai xe ben nao?", "Ben trai\nBen phai\nO giua\nTren via he", "Chon", "Thoat");
	    }
	}
    ...
    if(dialogid == GPS_SYSTEM)
	{
 		if(response)
		{
        	...
        	if(listitem == 1)
		    {
				new Float:JPoS[3],stringz[1029];
				stringz = "Cong viec\tDia diem\tKhoang cach";
				for(new z =0 ; z < 14 ; z++ ) 
				{
					switch(z) 
					{
                        case 0: JPoS[0] = 1468.7361, JPoS[1] = -1772.3065, JPoS[2] = 18.7958;
                        case 1: JPoS[0] = 1493.3691, JPoS[1] = -1772.3108, JPoS[2] = 18.7958;
                        case 2: JPoS[0] = 1744.1862, JPoS[1] = -1579.4226, JPoS[2] = 13.5471;
                        case 3: JPoS[0] = 2162.7639, JPoS[1] = -1676.5929, JPoS[2] = 15.0859;
                        case 4: JPoS[0] = 1099.73, JPoS[1] = -1504.67, JPoS[2] = 15.800;
                        case 5: JPoS[0] = 1929.1703, JPoS[1] = -1767.7230, JPoS[2] = 13.5469;
                        case 6: JPoS[0] = 1366.3973, JPoS[1] = -1275.0493, JPoS[2] = 13.5469;
                        case 7: JPoS[0] = 2227.6780, JPoS[1] = -1718.1304, JPoS[2] = 13.5162;
                        case 8: JPoS[0] = 1741.5220, JPoS[1] = -1863.6914, JPoS[2] = 13.5748;
                        case 9: JPoS[0] = 2162.7639, JPoS[1] = -1676.5929, JPoS[2] = 15.0859;
                        case 10: JPoS[0] = 2200.3245,JPoS[1] = -1972.8851,JPoS[2] = 13.5578;
                        case 11: JPoS[0] = 1836.6337,JPoS[1] = -1682.4321,JPoS[2] = 13.3398;
                        case 12: JPoS[0] = 2105.4529,JPoS[1] = -1809.5568,JPoS[2] = 13.5547;
                        case 13: JPoS[0] = 2424.3186,JPoS[1] = -2099.1064,JPoS[2] = 13.5469;
                        case 14: JPoS[0] = -491.6027,JPoS[1] = -193.9856,JPoS[2] = 78.3640;                         
					}
					new zone[MAX_ZONE_NAME],Float:Distance;
					Distance = GetPlayerDistanceFromPoint(playerid, JPoS[0], JPoS[1], JPoS[2]);
				    Get3DZone(JPoS[0],JPoS[1],JPoS[2], zone, sizeof(zone));
			...
			if(listitem == 2)
			{
			    return ShowPlayerDialog(playerid, TIMVIECLAM, DIALOG_STYLE_LIST, "DIA DIEM TIM VIEC","Tham tu\nBuon vu khi\nBuon thuoc phien\nVe si\nLuat su\nTai xe Taxi\nTho sua xe\nGai diem\nBoxer\nBuon ma tuy\nTho thu cong\nNguoi pha che\nTrucker\nPizza\nSua Chua Dau Khi\nGiao Xang\nDao Vang", "Chon", "Thoat");
			}
			if(listitem == 3)
			{
    ...
    if(dialogid == QUOCTICH)
	{
      if(response)
      {
      if(listitem == 0)
      {
      SetPlayerPos(playerid, 1743.08,-1849.21,13.58);
	  GameTextForPlayer(playerid, "~y~Welcome To Los Santos", 5000, 3);
      }
      if(listitem == 1)
      {
      SetPlayerPos(playerid, -2433.6299,511.4500,30.3828);
  	  GameTextForPlayer(playerid, "~y~Welcome To San Fierro", 5000, 3);
      }
      }
    }
   ...
   if(dialogid == TIMMAP)
	{
	    if(response)
	    {
	       	if(listitem == 0) // Tim Viec Lam
		    {
			ShowPlayerDialog(playerid, TIMVIECLAM, DIALOG_STYLE_LIST, "DIA DIEM TIM VIEC","Tham tu\nBuon vu khi\nBuon thuoc phien\nVe si\nLuat su\nTai xe Taxi\nTho sua xe\nGai diem\nBoxer\nBuon ma tuy\nTho thu cong\nNguoi pha che\nTrucker\nPizza\nSua Chua Dau Khi\nGiao Xang\nDao Vang", "Chon", "Thoat");
			}
			if(listitem == 1) // Tim Duong
		    {
			ShowPlayerDialog(playerid, TIMDUONG, DIALOG_STYLE_LIST, "DIA DIEM TIM DUONG","Shop xe\nSo canh sat\nVIP\nBenh vien\nTram xang\nCua hang tap hoa 24/7\nLay Ca\nBan Ca 1\nBan Ca 2 LS\nBan Ca 2 SF", "Chon", "Thoat");
			}
			if(listitem == 2) // Trogiupcansa
			{
			return cmd_trogiupcansa(playerid, "");
			}
		}
	}
    ...
    if(dialogid == Code4)
	{
	    if(response)
		{
			if(~strcmp(inputtext, "vaicalondaucatmoi"))
			{
			...
			{
				SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "{AA3333}[SysTem]{FFFF00}Dap An Sai Tang 1 Sao Vang");
	...
	if(dialogid == Code5)
	{
	    if(response)
		{
			if(~strcmp(inputtext, "Andaubuoiancut"))
			{
				for(new i = 0; i < sizeof(HouseInfo); i++)
				{
					if (IsPlayerInRangeOfPoint(playerid,3,HouseInfo[i][hExteriorX], HouseInfo[i][hExteriorY], HouseInfo[i][hExteriorZ]))
	...
	if(dialogid == DIALOG_NGUOITHUMUA)
{
       if(response)
    {
        if(listitem == 0)
		{
				SendClientMessageEx(playerid, COLOR_YELLOW, "Luu Y{FFFFFF}: /tuido De Xem KG Thit Ca Cua Ban.");
 				ShowPlayerDialog(playerid, BanThitCa, DIALOG_STYLE_INPUT, "Nhap So Thit Ca Muon Ban","{ff0000}Ban Muon Ban So Thit Ca Nay Cho NPC Thu Mua \n {FFFFFF}1KG Thit Ca = 10k SAD ", "Lua chon", "Huy bo");
				return 0;
		}
		if(listitem == 1)
        {
 			SendClientMessageEx(playerid, COLOR_GREY, "Dang Cap Nhat.");
 			return 0;
		}
		if(listitem == 2)
        {
...
if(dialogid == CHETAOVK)
	{
	 if(response)
	  {
	   if(listitem == 0) // Che Do
	   {
			PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
		    SetPlayerCheckpoint(playerid, 1551.32, -1504.34, 13.55 , 3.0);
			CP[playerid] = 252000;
            return 1;
  	   }
       if(listitem == 1) // Lay Da
       {
		  PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
		  SetPlayerCheckpoint(playerid, 1059.35,-2057.43, 13.13, 3.0);
		  CP[playerid] = 252000;
          return 1;
	    }
	    if(listitem == 2) // Chesung
	    {
		  PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
		  SetPlayerCheckpoint(playerid, 2166.36, -1733.84, 17.28, 3.0);
		  CP[playerid] = 252000;
		  return 1;
		}
     }
...
if(dialogid == BanThitCa)
    {
        if(response)
        {
            new typethit = abs(strval(inputtext));
            new giatribanca = typethit*10;
            if(strval(inputtext))
            {
                if(PlayerInfo[playerid][pThitCa] >= typethit)
                {
                    GivePlayerCash(playerid,giatribanca);
                    PlayerInfo[playerid][pThitCa] -=typethit ;
                    format(string, sizeof(string), "* {ff0000}(%s) Da Sell %d KG Thit Ca Thanh %d SAD .",GetPlayerNameEx(playerid),typethit, giatribanca);
                    SendClientMessageEx(playerid, COLOR_LIGHTBLUE, string);
                }
                else
                {
                    format(string, sizeof(string), "* {ff0000}Ban Khong Du %d KG Thit Ca De Sell .",typethit);
                    SendClientMessageEx(playerid, COLOR_LIGHTBLUE, string);
                }
            }
        }
	...
	if(dialogid == DIALOG_CAIDAT)
{
       if(response)
    {
        ...
        {   
            if(PlayerInfo[playerid][pDonateRank] >= 1 || PlayerInfo[playerid][pAdmin] >= 2) {
                if(GetPVarType(playerid, "togVIP")) {
                    ...
                    SendClientMessageEx(playerid, COLOR_WHITE, "VIP chat da duoc dong.");
                }
                else {
                    SetPVarInt(playerid, "togVIP", 1);
                    SendClientMessageEx(playerid, COLOR_WHITE, "VIP chat da duoc mo.");
                }
            }
            else SendClientMessageEx(playerid, COLOR_GREY, "Ban khong co VIP.");
            return 1;
        }
        if(listitem == 2) //newbie
        {
            if (!gNewbie[playerid])
            {
                gNewbie[playerid] = 1;
        ...
        if(listitem == 6) //doi ma pin
        {
                ShowPlayerDialog(playerid, DIALOG_CREATEPIN, DIALOG_STYLE_INPUT, "Doi Ma Pin", "Nhap so pin moi de thay doi hien tai cua ban.", "Thay doi", "Cancel");
        }
        if(listitem == 7)
        {
            if (gPlayerLogged{playerid})
            {
                ShowPlayerDialog(playerid, DIALOG_CHANGEPASS, DIALOG_STYLE_INPUT, "Thay doi mat khau", "Vui long nhap mat khau moi cua ban!", "Thay doi", "Thoat" );
            }
                return 1;
        }   
        if(listitem == 8)
        {
           return cmd_fixketvw(playerid, "");
        }
        if(listitem ==9)
        {
	...
	if(dialogid == DIALOG_THIBANGLAIA)
    {
        if(response) 
        {
            SendClientMessage(playerid, COLOR_RED, "Ban da tra loi sai! Hay thu lai nao!");
        }
        else 
        {
            SendClientMessage(playerid, COLOR_GREEN, "Ban da tra loi dung!");
            ShowPlayerDialog( playerid, DIALOG_THIBANGLAIB, DIALOG_STYLE_MSGBOX, "Ly thuyet", "Khi di den vong xuyen can phai nhuong duong cho xe ben nao",  "Ben Trai", "Ben Phai" );
        }
        return 1; 
    }

	if(dialogid == DIALOG_THIBANGLAIB)
    {
        if(response) 
        {
            SendClientMessage(playerid, COLOR_GREEN, "Ban da tra loi dung!");
            ShowPlayerDialog( playerid, DIALOG_THIBANGLAIC, DIALOG_STYLE_MSGBOX, "Ly thuyet", "Khi gap den bao dong giao thong mau do ta nen lam gi?",  "Di Tiep", "Dung Lai" );
        }
        else
        {
            SendClientMessage(playerid, COLOR_RED, "Ban da tra loi sai! Hay thu lai nao!");
	...
	if(dialogid == DIALOG_THIBANGLAIC)
    {
        if(response)
        {
            SendClientMessage(playerid, COLOR_RED, "Ban da tra loi sai! Hay thu lai nao!");
        ...
        {
        SendClientMessage(playerid, COLOR_GREEN, "{fbf10c}Ban da tra loi dung!");
        SendClientMessage(playerid, COLOR_WHITE, "{fbf10c}bay gio chung ta se bat dau qua phan thuc hanh thi lai xe nhe!");
        SendClientMessage(playerid, COLOR_WHITE, "{fbf10c}Luu Y: Ban hay dung chiec xe nay de di den checkpoint mau do nhe. Neu ban bi va cham vao dau do thi se bi truot ngay lap tuc nhe!");
	    SetPlayerPos(playerid, 1408.2273,-1792.1929,13.5469);
	    SetPlayerInterior(playerid,0);
	    PlayerInfo[playerid][pInt] = 0;
	    new Rand = random (9000);
	    PlayerInfo[playerid][pVW] = Rand;
	    new vw = PlayerInfo[playerid][pVW];
	    SetPlayerVirtualWorld(playerid,  vw);
	    SetTimerEx("Thibanglai", 3000, 0, "d", playerid);
        }
        return 1; 
    }
	...
	if(dialogid == XEPHANG)
	{
	    if(response)
	    {
	        if(listitem == 0) //TOP Credits
	        {
                new Cache:Result, ss[2500];
				Result = mysql_query(MainPipeline, "SELECT `Credits`, `Username` FROM `accounts` ORDER BY `Credits` DESC LIMIT 30");
				if(cache_num_rows())
				{
				    new money, username[MAX_PLAYER_NAME + 1];
				    format(ss,sizeof(ss),"%sTOP\tNguoi choi\tCOIN\n", ss);
    			...
    			cache_delete(Result);
	    		ShowPlayerDialog(playerid, DIALOG_NOTHING, DIALOG_STYLE_TABLIST_HEADERS, "{FFFFFF}TOP 30 - COIN", ss, "Ok", "");
 			}
 		}
 		if(listitem == 1)
        {
                new Cache:Result, ss[2500];
				Result = mysql_query(MainPipeline, "SELECT `Money`, `Username` FROM `accounts` ORDER BY `Money` DESC LIMIT 30");
				if(cache_num_rows())
				{
				    new money, username[MAX_PLAYER_NAME + 1];
    			...
    			cache_delete(Result);
	    		ShowPlayerDialog(playerid, DIALOG_NOTHING, DIALOG_STYLE_TABLIST_HEADERS, "{FFFFFF}TOP 30 - MONEY", ss, "Ok", "");
	     }
	     if(listitem == 2)
         {
                new Cache:Result, ss[2500];
				Result = mysql_query(MainPipeline, "SELECT `Level`, `Username` FROM `accounts` ORDER BY `Level` DESC LIMIT 30");
				if(cache_num_rows())
				{
				    new money, username[MAX_PLAYER_NAME + 1];
    			...
    			cache_delete(Result);
	    		ShowPlayerDialog(playerid, DIALOG_NOTHING, DIALOG_STYLE_TABLIST_HEADERS, "{FFFFFF}TOP 30 - LEVEL", ss, "Ok", "");
	     }
	     if(listitem == 3)
         {
                new Cache:Result, ss[2500];
				Result = mysql_query(MainPipeline, "SELECT `Kill`, `Username` FROM `accounts` ORDER BY `Kill` DESC LIMIT 30");
				if(cache_num_rows())
				{
				    new money, username[MAX_PLAYER_NAME + 1];
				    format(ss,sizeof(ss),"%sTOP\tNguoi choi\tSO KILL\n", ss);
					for(new i = 0; i < cache_num_rows(); ++i)
					{
						money = cache_get_row_int(i, 0);
						cache_get_row(i, 1, username);
    			...
    			cache_delete(Result);
	    		ShowPlayerDialog(playerid, DIALOG_NOTHING, DIALOG_STYLE_TABLIST_HEADERS, "{FFFFFF}TOP 30 - GIET NGUOI NHIEU NHAT SERVER", ss, "Ok", "");
	     }
	     if(listitem == 4)
         {
                new Cache:Result, ss[2500];
				Result = mysql_query(MainPipeline, "SELECT `Death`, `Username` FROM `accounts` ORDER BY `Death` DESC LIMIT 30");
				if(cache_num_rows())
				{
				    new money, username[MAX_PLAYER_NAME + 1];
				    format(ss,sizeof(ss),"%sTOP\tNguoi choi\tSO LAN DEATH\n", ss);
					for(new i = 0; i < cache_num_rows(); ++i)
					{
						money = cache_get_row_int(i, 0);
						cache_get_row(i, 1, username);
    			...
    			cache_delete(Result);
	    		ShowPlayerDialog(playerid, DIALOG_NOTHING, DIALOG_STYLE_TABLIST_HEADERS, "{FFFFFF}TOP 30 - CHET NHIEU NHAT SERVER", ss, "Ok", "");
	     }
 	}
	...
	if(dialogid == TIMVIECLAM)
    {
        if(response)
        {
            ...
            {
                SetPlayerCheckpoint(playerid, 2424.28,-2098.87,13.54);
                CP[playerid] = 252007;
            }
            ...
            else if(listitem == 14)// Sua Chua Dau Khi (SF)
            {
                SetPlayerCheckpoint(playerid, 581.5925,1227.0088,11.7188, 5);
                CP[playerid] = 252007;           
            }
            else if(listitem == 15)// Giao Xang (SF)
            {
                SetPlayerCheckpoint(playerid, -1709.6616,400.5131,7.1872, 5);
                CP[playerid] = 252007;
            }
            else if(listitem == 16)// Dao Vang
            {
                return ShowPlayerDialog(playerid, CV_DAOVANG, DIALOG_STYLE_LIST, "Cong Vien Dao Vang","Dao Vang\nBan Vang\nXin Viec", "Chon", "Thoat");
            }
        }
    }

    if(dialogid == CV_DAOVANG)
    {
        if(response)
        {
            if(listitem == 0)// Dao Vang
            {
                SetPlayerCheckpoint(playerid, -551.3004,-141.9308,78.3619, 5);
                CP[playerid] = 252006;
            }
            if(listitem == 1)// Ban Vang
            {
                SetPlayerCheckpoint(playerid, -1842.0101,-8.7142,15.1172, 5);
                CP[playerid] = 252006;
            }
            if(listitem == 3)// Xin Viec
            {
                SetPlayerCheckpoint(playerid, -499.5942,-197.7514,78.4047, 5);
                CP[playerid] = 252006;
            }
        }
    }
    
    if(dialogid == Job_KhaiThac) // xin viec
    {
        if(response)
        {
            if(listitem == 0) //Xin viec
   			...
   			if(PlayerInfo[playerid][pLevel] >= 1)
			{
		    	if(PlayerInfo[playerid][pJob] == 0)
            	{
		        	GettingJob[playerid] = 36;
                	PlayerInfo[playerid][pJob] = GettingJob[playerid];
                	SendClientMessageEx(playerid, COLOR_YELLOW, "Ban Da Xin Viec Khai Thac Thanh Cong");
                }
                else return SendClientMessageEx(playerid, COLOR_YELLOW, "Ban Dang Co Cong Viec Vui Long Thoat Viec De Xin Viec Tiep!");
			}
    ...
    if(dialogid == BANKHOANGSAN)
	{
	    if(response)
	    {
            if(listitem == 0)
            {
                if(PlayerInfo[playerid][pFE] >= 1)
     			{
                    PlayerInfo[playerid][pFE] -= 1;
                    PlayerInfo[playerid][pCash] +=10;
                    SendClientMessage(playerid, COLOR_GREY, "Ban da ban 1 FE voi gia 10$.");
                    return 1;
                }
				else
				{
				    SendClientMessage(playerid, COLOR_GREY, "Ban khong co FE");
				}
            }
            if(listitem == 1)
            {
                if(PlayerInfo[playerid][pCu] >= 1)
     			{
                    PlayerInfo[playerid][pCu] -= 1;
                    PlayerInfo[playerid][pCash] +=20;
                    SendClientMessage(playerid, COLOR_GREY, "Ban da ban 1 Cu voi gia 20$");
                    return 1;
                }
				else
				{
				    SendClientMessage(playerid, COLOR_GREY, "Ban khong co Cu");
				}
            }
            if(listitem == 2)
            {
               if(PlayerInfo[playerid][pAu] >= 1)
     			{
                    PlayerInfo[playerid][pAu] -= 1;
                    PlayerInfo[playerid][pCash] += 500;
                    SendClientMessage(playerid, COLOR_GREY, "Ban da ban 1 Au voi gia 500$");
                    return 1;
                }
				else
				{
				    SendClientMessage(playerid, COLOR_GREY, "Ban khong co Au");
				}
            }
            if(listitem == 3)
            {
                if(PlayerInfo[playerid][pFE] >= 14)
                {
                    SendClientMessage(playerid, -1, "Ban Da Dung 14 FE Che Tao Thanh Cong Khau 9mm!");
                    PlayerInfo[playerid][pFE] -= 14;
                    GivePlayerWeapon(playerid, 22, 60000);
                }
                else
                {
                    SendClientMessage(playerid, -1, "Ban khong co du FE de che tao sung!");
                }
            }
            if(listitem == 4)
            {
                if(PlayerInfo[playerid][pFE] >= 32)
                {
                    SendClientMessage(playerid, -1, "Ban Da Dung 32 FE Che Tao Thanh Cong Khau ShotGun!");
                    PlayerInfo[playerid][pFE] -= 32;
            ...
            if(listitem == 5)
            {
                if(PlayerInfo[playerid][pCu] >= 30)
                {
                    SendClientMessage(playerid, -1, "Ban Da Dung 30 Cu Che Tao Thanh Cong Khau Uzi!");
                    PlayerInfo[playerid][pCu] -= 30;
                    GivePlayerWeapon(playerid, 28, 60000);
                }
                else
                {
                    SendClientMessage(playerid, -1, "Ban khong co du Cu de che tao sung!");
                }
            }
            if(listitem == 6)
            {
                if(PlayerInfo[playerid][pCu] >= 37)
                {
                    SendClientMessage(playerid, -1, "Ban Da Dung 37 Cu Che Tao Thanh Cong Khau Mp5");
                    PlayerInfo[playerid][pCu] -= 37;
            ...
            if(listitem == 7)
            {
                if(PlayerInfo[playerid][pAu] >= 30)
                {
                    SendClientMessage(playerid, -1, "Ban Da Dung 30 Au Che Tao Thanh Cong Khau Ak47!");
                    PlayerInfo[playerid][pAu] -= 30;
                    GivePlayerWeapon(playerid, 30, 60000);
                }
                else
                {
                    SendClientMessage(playerid, -1, "Ban khong co du Au de che tao sung!");
                }
            }
            if(listitem == 8)
            {
                if(PlayerInfo[playerid][pAu] >= 30)
                {
                    SendClientMessage(playerid, -1, "Ban Da Dung 30 Au Che Tao Thanh Cong Khau M4!");
                    PlayerInfo[playerid][pAu] -= 30;
	...
	if(dialogid == Job_PhucVu) // xin viec
    {
        if(response)
        {
            if(listitem == 0) //Xin viec
            ...
            SendClientMessageEx(playerid, COLOR_YELLOW, "Chi VIP/Famed moi co the nhan duoc hai cong viec!");
		        	...
		        	GettingJob[playerid] = 37;
                	PlayerInfo[playerid][pJob] = GettingJob[playerid];
                	SendClientMessageEx(playerid, COLOR_YELLOW, "Ban Da Xin Viec Phuc Vu Thanh Cong, Go:/phucvu De Bat Dau Lam Viev");
                }
                else return SendClientMessageEx(playerid, COLOR_YELLOW, "Ban da co cong viec phu hoac khong co Vip/Famed de co the nhan cong viec phu");
			}
			else return SendClientMessageEx(playerid, COLOR_GREY, "Ban phai dat it nhat level 2 moi co the tro thanh Nguoi Phuc Vu");
		}
			if(listitem == 2) // Nghi viec 1
		    {
                //PlayerInfo[playerid][pJob] = 0;
	...
	if(dialogid == TIMDUONG)
    {
        if(response)
        {
            ...
            if(listitem == 6)// Lay Ca(LS)
            {
                SetPlayerCheckpoint(playerid, 401.35,-1922.74,2.17, 5);
                CP[playerid] = 252006;
             }
             if(listitem == 7)// Ban Ca(LS)
            {
                SetPlayerCheckpoint(playerid, 567.64,-1764.02,5.81, 5);
                CP[playerid] = 252006;
             }
             if(listitem == 7)// Ban Ca 2(LS)
            {
                SetPlayerCheckpoint(playerid, 388.03,-1897.16,7.83, 5);
                CP[playerid] = 252006;
             }
             if(listitem == 7)// Ban Ca 2(SF)
            {
                SetPlayerCheckpoint(playerid, -1575.5219,1277.2760,7.1793, 5);
                CP[playerid] = 252006;
            }
        }
    }
		...
		if(PlayerVehicleInfo[playerid][listitem][pvSpawned]) {
			...
			if((!IsVehicleOccupied(iVehicleID) || IsPlayerInVehicle(playerid, iVehicleID)) && !IsVehicleInTow(iVehicleID)) {
				...
				if(vehiclehealth < 50) {
					...
					PlayerVehicleInfo[playerid][listitem][pvHealth] = vehiclehealth;
		...
		else if((PlayerInfo[playerid][pRVehRestricted] > gettime() || PlayerVehicleInfo[playerid][listitem][pvRestricted] > gettime()) && IsRestrictedVehicle(PlayerVehicleInfo[playerid][listitem][pvModelId]))
        {
			...
			if(PlayerInfo[playerid][pDonateRank] == 0 && VehicleSpawned[playerid] >= 2) {
				...
				SendClientMessageEx(playerid, COLOR_GREY, "The vehicle slot is empty.");
	                ...
	                new
						iVeh = CreateVehicle(PlayerVehicleInfo[playerid][listitem][pvModelId], X+2,Y,Z, PlayerVehicleInfo[playerid][listitem][pvPosAngle],PlayerVehicleInfo[playerid][listitem][pvColor1], PlayerVehicleInfo[playerid][listitem][pvColor2], -1);
				...
				if (PlayerVehicleInfo[playerid][listitem][pvHealth] <= 400) {
                    SetVehicleHealth(iVeh, 400);
				}
				else SetVehicleHealth(iVeh, PlayerVehicleInfo[playerid][listitem][pvHealth]);
		...
		switch (listitem)
		{
			...
			case 4:
			{
			    if(PlayerInfo[playerid][pCarLic] == 0)
			    {
			        if(GetPlayerCash(playerid) < 500000)
			        {
			            SendClientMessageEx(playerid, COLOR_GREY, "Ban khong du chi phi de thi bang lai xe");
			            return 1;
			        }
                    ShowPlayerDialog(playerid, DIALOG_THIBANGLAIA, DIALOG_STYLE_MSGBOX, "Ly thuyet", "Khi ta tham gia giao thong luon luon phai di duong ben tay nao?", "Tay trai", "Tay phai");
				}
				else SendClientMessageEx(playerid, COLOR_GREY, "Ban da co giay  phep lai xe.");
			}
			case 3:
...
/*	if(dialogid == MDC_CHECK && response)
	...
	if(dialogid == DIALOG_PHONE)
	{
		if(response)
    	{
   			ShowPlayerDialog(playerid, DIALOG_PHONE1, DIALOG_STYLE_INPUT, "SO DIEN THOAI","Xin vui long nhap mot {ff0000}so dien thoai{ffffff} ma ban muon goi", "Call", "Cancel");
   		}
	}
	if(dialogid == DIALOG_PHONE1)
    {
		new string[128];
		if (response)
		{
		   if (PlayerInfo[playerid][pJailTime] > 0)
	        {
		        SendClientMessageEx(playerid,COLOR_RED,"Ban khong the su dung Dien Thoai khi dang O? tu`.");
	            return 1;
	        }
	        if(PlayerTied[playerid] != 0 || PlayerCuffed[playerid] != 0)
	        {
		        SendClientMessageEx(playerid,COLOR_RED,"Ban khong the su dung trong khi dien thoai cua ban dang bi han che.");
		        return 1;
	        }
        	...
        	{
         		SendClientMessageEx(playerid, COLOR_RED, "  Dien thoai dang ban...");
        		return 1;
        	}
        	if(Mobile[playerid] != INVALID_PLAYER_ID)
        	{
        		SendClientMessageEx(playerid, COLOR_RED, "  Ban dang co mot cuoc goi...");
        		return 1;
        	}
        	foreach(new i: Player)
        	{
