		...
		case LOADUSERDATA_THREAD:
		{
			if(IsPlayerConnected(extraid))
			{
				...
				for(new row;row < rows;row++)
				{
					...
					cache_get_field_content(row,  "DirtyMoney", szResult, MainPipeline); PlayerInfo[extraid][pDirtyMoney] = strval(szResult);
                    cache_get_field_content(row,  "CayCanSa", szResult, MainPipeline); PlayerInfo[extraid][pCayCanSa] = strval(szResult);
                    cache_get_field_content(row,  "CayMaTuy", szResult, MainPipeline); PlayerInfo[extraid][pCayMaTuy] = strval(szResult);
                    ...
                    cache_get_field_content(row,  "DaQuyy", szResult, MainPipeline); PlayerInfo[extraid][pDaQuy] = strval(szResult);
                    cache_get_field_content(row,  "CuopNha", szResult, MainPipeline); PlayerInfo[extraid][pCuopNha] = strval(szResult);
                    cache_get_field_content(row, "CMND", szResult, MainPipeline); PlayerInfo[extraid][pCMND] = strval(szResult);
                    cache_get_field_content(row,  "BanhChung", szResult, MainPipeline); PlayerInfo[extraid][pBanhChung] = strval(szResult);
                    cache_get_field_content(row,  "LaChuoi", szResult, MainPipeline); PlayerInfo[extraid][pLaChuoi] = strval(szResult);
                    cache_get_field_content(row,  "GaoNep", szResult, MainPipeline); PlayerInfo[extraid][pGaoNep] = strval(szResult);
                    cache_get_field_content(row,  "Vang", szResult, MainPipeline); PlayerInfo[extraid][pVang] = strval(szResult);
                    cache_get_field_content(row,  "FE", szResult, MainPipeline); PlayerInfo[extraid][pFE] = strval(szResult);
                    cache_get_field_content(row,  "Cu", szResult, MainPipeline); PlayerInfo[extraid][pCu] = strval(szResult);
                    cache_get_field_content(row,  "Au", szResult, MainPipeline); PlayerInfo[extraid][pAu] = strval(szResult);
                    cache_get_field_content(row,  "CrashZone", szResult, MainPipeline); PlayerInfo[extraid][CrashZone] = strval(szResult);
                    cache_get_field_content(row,  "Manhxe", szResult, MainPipeline); PlayerInfo[extraid][pManhxe] = strval(szResult);
					
					cache_get_field_content(row,  "Points", szResult, MainPipeline); PlayerInfo[extraid][pPoints] = strval(szResult);
					cache_get_field_content(row,  "UyTin", szResult, MainPipeline); PlayerInfo[extraid][pUyTin] = strval(szResult);
					...
					cache_get_field_content(row,  "ThitCa", szResult, MainPipeline); PlayerInfo[extraid][pThitCa] = strval(szResult);
					cache_get_field_content(row,  "DaQuy", szResult, MainPipeline); PlayerInfo[extraid][pDaQuy] = strval(szResult);
...
stock g_mysql_SaveAccount(playerid)
{
	...
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "ThitCa", PlayerInfo[playerid][pThitCa]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "DaQuyy", PlayerInfo[playerid][pDaQuy]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "CuopNha", PlayerInfo[playerid][pCuopNha]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "BanhChung", PlayerInfo[playerid][pBanhChung]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "LaChuoi", PlayerInfo[playerid][pLaChuoi]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "GaoNep", PlayerInfo[playerid][pGaoNep]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Vang", PlayerInfo[playerid][pVang]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "FE", PlayerInfo[playerid][pFE]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Cu", PlayerInfo[playerid][pCu]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Au", PlayerInfo[playerid][pAu]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "CrashZone", PlayerInfo[playerid][CrashZone]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Points", PlayerInfo[playerid][pPoints]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "UyTin", PlayerInfo[playerid][pUyTin]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Manhxe", PlayerInfo[playerid][pManhxe]);
