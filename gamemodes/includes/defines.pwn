...
#define			SAMP_WEB					"samp.baocms.net" // f5
...
#define            DIALOG_BANK                   (11030)
#define            DIALOG_CHUYENTIEN      (11031)
#define            DIALOG_CHUYENTIEN2       (11032)
#define            DIALOG_CHUYENTIEN1        (11033)
#define           DANGKYBANK                  (11034)
...
#define			DIALOG_GIFTBOX_INFO			(5078)
#define             DIALOG_CHUYENTIEN               (5079)
#define             DIALOG_CHUYENTIEN1             (5080)
#define             DIALOG_CHUYENTIEN2             (5086)
#define             DIALOG_BANK                   (5082)
#define              DIALOG_PHONE                (5081)
#define             DIALOG_GUITTIEN             (5143)
#define              DANGKYBANK                   (5084)
#define             DIALOG_PHONE1               (5085)
#define             DIALOG_CAIDAT                  (5087)
#define         DIALOG_NGUOITHUMUA              (5088)
#define         BanThitCa        			(5089)
#define         Banthitca                        (5090)
#define         DIALOG_THIBANGLAIA          (5092)
#define         DIALOG_THIBANGLAIB          (5093)
#define         DIALOG_THIBANGLAIC          (5094)
#define         DIALOG_NANGCAPSUNG       (5095)
#define         DIALOG_NANGCAPSUNG1       (5096)
#define          CHETAOVK    (5097)
#define                         Code4                         		(5098)
#define                         Code5                         		(5099)
#define                         Code6                         		(5100)
#define          TIMMAP        (5101)
#define          GPS_SYSTEM        (5102)
#define 		ACTOR_POT				(5573)
#define 		ACTOR_CRACK 				(5572)
#define 		HUONGDANBUONCANSAMATUY 		(5570)
#define         TROGIUPCANSA         (5574)
#define          MUAVUKHI          (5575)
#define 		ACTOR_DRUGSDEALER 			(5571)
#define 		ACTOR_ARMSDEALER 			(5567)
#define 		BANCANSA					(5568)
#define 		BANMATUY					(5569)

#define         Dialog_Phone				(5745)
#define         Dialog_Phone_Call			(5746)
#define         Dialog_Phone_SMS1			(5747)
#define         Dialog_Phone_SMS2			(5748)
#define         Dialog_Phone_DanhBa			(5749)
#define         Dialog_Phone_Bank1			(5750)
#define         Dialog_Phone_Bank2			(5751)

#define 						MAX_SLOT 								7
#define 						MAX_ITEM 								7
 #define         HUY_HOCLAIXE                (5108)
#define         HOCLAIXE_STEP_1             (5109)
#define         HOCLAIXE_STEP_2             (5110)
#define         HOCLAIXE_STEP_3             (5111)
#define         HOCLAIXE_STEP_4             (5112)
#define         HOCLAIXE_STEP_5             (5113)
#define         HOCLAIXE_STEP_6             (5114)
#define         HOCLAIXE_STEP_7             (5116)
#define         HOCLAIXE_STEP_8             (5117)
#define         HOCLAIXE_STEP_9             (5118)
#define         HOCLAIXE_STEP_10            (5119)
#define         HOCLAIXE_XONGTRACNGHIEM     (5120)
#define         DIALOG_LICENSE_BUY_TEST     (5107)
#define         DIALOG_GHEPXE             (5121)
#define         DIALOG_SPAWNLOGIN       (5122)
#define         DIALOG_XE     (5123)
#define         TRANGTHAI     (5124)
#define         QUOCTICH       (5125)
#define		 BANCA					    (9489)
 #define        BANBANHCHUNG      (9490)
#define         DIALOG_TETNGUYENDAN         (9491)
#define         TROGIUPTETNGUYENDAN         (9492)
#define         CHEBIENBANHCHUNG            (5126)
#define         BANHCHUNG_INV       (5127)
#define         DIALOG_BANKHOANGSAN       (5128)
#define         DIALOG_SELLKHOANGSAN        (5129)
#define         BANVANG       (5130)
#define         CV_DAOVANG          (5131)
#define         Job_DaoVang           (5134)
#define         BANKHOANGSAN      (5135)
#define         Job_KhaiThac        (5136)
#define         Job_PhucVu            (5137)
 
#define         DIALOG_VONGQUAY             (9145)
#define         VONGQUAY_SAD                (9146)
#define         VONGQUAY_CREDITS            (9147)
#define         VONGQUAY_1               	(9148)
#define         VONGQUAY_2               	(9149)
#define         VONGQUAY_3               	(9150)
#define         VONGQUAY_4               	(9151)
#define         VONGQUAY_5               	(9152)

#define         VONGQUAY_6               	(9153)
#define         VONGQUAY_7               	(9154)
#define         VONGQUAY_8               	(9155)
#define         VONGQUAY_9               	(9156)
#define         VONGQUAY_10               (9157)
 #define         DIALOG_VONGQUAY             (9145)
#define         VONGQUAY_SAD                (9146)
#define         VONGQUAY_CREDITS            (9147)
#define         VONGQUAY_1               	(9148)
...
#define         VONGQUAY_9               	(9156)
#define         VONGQUAY_10               	(9157)
#define         DIALOG_FINN               	(9158)


#define         AdminVongQuay             (9159)

#define         EDIT_MONEY                (9160)
#define         EDIT_CREDITS              (9161)

#define         EDIT_TOYS                 (9162)
#define         EDIT_TOYS1                (9163)
#define         EDIT_TOYS2                (9164)
#define         EDIT_TOYS3                (9165)
#define         EDIT_TOYS4                (9166)
#define         EDIT_TOYS5                (9167)

#define         EDIT_TOYSVIP              (9168)
#define         EDIT_TOYSVIP1             (9169)
#define         EDIT_TOYSVIP2             (9170)
#define         EDIT_TOYSVIP3             (9171)
#define         EDIT_TOYSVIP4             (9172)
#define         EDIT_TOYSVIP5             (9173)

#define         EDIT_XEIC             	  (9174)
#define         EDIT_XE1             	  (9175)
#define         EDIT_XE2             	  (9176)
#define         EDIT_XE3             	  (9177)
#define         EDIT_XE4             	  (9178)
#define         EDIT_XE5             	  (9179)

#define         EDIT_XECREDITS            (9180)
#define         EDIT_XEVIP1               (9181)
#define         EDIT_XEVIP2               (9182)
#define         EDIT_XEVIP3               (9183)
#define         EDIT_XEVIP4               (9184)
#define         EDIT_XEVIP5               (9185)
//END
#define			GHEPXE 		            	(9186)
